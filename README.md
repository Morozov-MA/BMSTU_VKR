...
Morozov M.A. BKP_final_1.ipynb - начало кода

Morozov M.A. BKP_final_2.ipynb - продолжение кода

Morozov M.A. BKP_final_3.ipynb - завершение кода

Morozov M.A. BKP_final_1.html - первая часть кода в html

Morozov M.A. BKP_final_2.html - вторая часть кода в html

Morozov M.A. BKP_final_3.html - третья часть кода в html

BKP_Morozov_presentazia_final.pptx - презентация ВКР для защиты в формате pptx

Пояснительная записка Morozov M.A..docx - описание работы на 39 стр в формате docx
